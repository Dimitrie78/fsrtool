...
class AleFactory {
	...
	/**
	 * Loads configuration file and returns instance of AleZKillboard class
	 *
	 * @param array $config
	 * @return AleZKillboard
	 */
	public static function getZKillboard(array $config = array(), $newInstance = false) {
		return self::get('ZKillboard', $config, $newInstance);
	}
