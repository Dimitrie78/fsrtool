...
{* ------------------------------- *}
<script type="text/javascript" src="classes/modal.js"></script>
<script type="text/javascript" src="classes/jqry_plugins/timerskill.js"></script>
<script type="text/javascript" src="classes/jqry_plugins/jquery.ba-dotimeout.min.js"></script>
{literal}<script type="text/javascript">
$(document).ready(function(){
	$('span.timerskill').each(function(){
		$(this).timerskill();
	});	
});
</script>{/literal}

<div id="title">&raquo; My Skills</div>
    ...
    <tr>
      ...
      <div style="margin-top: 20px; margin-bottom: 24px;">
        <div style="margin-top: 20px;">
          <div style="border-top: 1px solid rgb(67, 67, 67); border-bottom: 1px solid rgb(67, 67, 67); background: rgb(44, 44, 56) no-repeat scroll 74px 5px; margin-bottom: 10px; -moz-background-clip: -moz-initial; -moz-background-origin: -moz-initial; -moz-background-inline-policy: -moz-initial; height: 22px;"></div>
